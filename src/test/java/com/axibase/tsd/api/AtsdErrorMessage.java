...
public class AtsdErrorMessage {
    ...
    public static final String AGGREGATE_NON_DETAIL_REQUIRE_PERIOD = "IllegalArgumentException: Interpolation type is required for non-DETAIL aggregate function";
